<?php
	...
	$stmt = $auth_user->runQuery("SELECT * FROM user WHERE nim=:user_id");
	$stmt->execute(array(":nim"=>$user_id));
...
<title>welcome - <?php print($userRow['kontak']); ?></title>
</head>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
			  ...
			  <span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo $userRow['kontak']; ?>&nbsp;<span class="caret"></span></a>
